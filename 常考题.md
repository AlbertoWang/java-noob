...
* [公共祖先节点](https://www.nowcoder.com/practice/e0cc33a83afe4530bcec46eba3325116?tpId=190&tqId=35225&rp=1&ru=%2Factivity%2Foj&qru=%2Fta%2Fjob-code-high-rd%2Fquestion-ranking&tab=answerKey)（考虑非递归）[阿里]；
* [链表求和](https://www.nowcoder.com/practice/c56f6c70fb3f4849bc56e33ff2a50b6b?tpId=190&tqId=35219&rp=1&ru=%2Fta%2Fjob-code-high-rd&qru=%2Fta%2Fjob-code-high-rd%2Fquestion-ranking&tab=answerKey)[阿里]；
...
* [最长递增子序列](https://leetcode-cn.com/problems/longest-increasing-subsequence/)[阿里]；
...
* 数字序列，除了一个元素外，其他元素都出现了两次，找到出现一次的元素（使用位运算）[阿里]；
* 链表从后向前遍历，每k个编入一组（使用栈）[百度]；
* [API限流算法](https://github.com/AlbertoWang/java-noob/blob/master/src/main/java/cn/albertowang/datastructure/limiting/FlowLimit.java)（考察`synchronized`）[阿里]；
