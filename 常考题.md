...
* [API限流算法](https://github.com/AlbertoWang/java-noob/blob/master/src/main/java/cn/albertowang/datastructure/limiting/FlowLimit.java)（考察`synchronized`）；
* [大量QQ号存储](https://github.com/AlbertoWang/java-noob/blob/master/src/main/java/cn/albertowang/datastructure/storeqq/QQSet.java)（考察位运算与防溢出策略）；
